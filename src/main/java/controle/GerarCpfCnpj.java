...
public class GerarCpfCnpj {
	...
	/*
	 * public static void main(String[] args) { GerarCpfCnpj gerador = new
	 * GerarCpfCnpj(); String cpf = gerador.cpf(true);
	 ...
	 * 
	 * String rg = gerador.rg(true); System.out.printf("RG: %s", rg); }
	 */
