...
public class CheckingMails {
	...
	public static void check(String host, String storeType, final String user, final String password) {
		try {
			...
			for (int i = 0, n = messages.length; i < n; i++) {
				...
				System.out.println("Text: " + message.getDataHandler());
	...
	public static void main(String[] args) {
		...
		//String username = "nikola.cadmo@gmail.com";// change accordingly
		//String password = "Evom!move";// change accordingly
		
		String username = "4i4.tecnologia@gmail.com";// change accordingly
		String password = "cedro@nds2";// change accordingly
